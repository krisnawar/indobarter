...
<head>
  <meta charset="utf-8">
  <meta name="description" content="Indobarter Company Profile">
  <meta name="keywords" content="Indobarter">
  <meta name="author" content="Bayu Setya Ajie Perdana Putra">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Indobarter | Log in</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?= base_url() ?>" class="logo mr-auto"><img src="<?= base_url('assets/img/logo-png.png') ?>" alt="" class="img-fluid"><br><span style="color:#5ab9f7">INDO</span><span style="color:#ffd700">BARTER</span></a>
    </div>
    <!-- /.login-logo -->
    <?php
    if (flashdata('msg')) {
